...
public class BusPortalTravelsService {
	...
	public TravelsDTO getTravel(String name) {
		...
		ResponseEntity<TravelsDTO> rec = restTemplate.getForEntity(travelURL + name, TravelsDTO.class);
...
//
//		ResponseEntity<TravelsDTO> rec = restTemplate.postForEntity(travelURL, httpEntity, TravelsDTO.class);
//
//		return rec.getBody();
//
//	}

	public String postTravel(TravelsDTO travelsDTO) {

		HttpHeaders httpHeader = new HttpHeaders();
		HttpEntity<TravelsDTO> httpEntity = new HttpEntity<TravelsDTO>(travelsDTO, httpHeader);

		restTemplate.postForEntity(travelsURL, httpEntity, Void.class);
	...
	public List<TravelsDTO> bookings() {
		...
		ResponseEntity<ArrayList> rec = restTemplate.getForEntity(travelURL, ArrayList.class);
	...
	public TravelsDTO getTravelsByContactNumber(String contactNumber) {
		...
		ResponseEntity<TravelsDTO> rec = restTemplate.getForEntity(travelURL + contactNumber, TravelsDTO.class);
